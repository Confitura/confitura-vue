        ...
        <div class="ratingModal__body">
            ...
            <div class="ratingModal__comment">
                <md-field class="ratingModal__commentFiled">
                    <label>comment</label>
                    <md-textarea class="ratingModal__commentInput" v-model="comment" maxlength="300"></md-textarea>
                </md-field>
            </div>

            <div class="ratingModal__actions">
                <md-button class="md-raised" @click="close()">Cancel</md-button>
                <md-button class="md-raised" @click="save()">Save my feedback</md-button>
            </div>
        </div>
    </Modal>
</template>
...
export default class PresentationRateModal extends Vue {
  ...
  public save() {
    this.$store.dispatch(RATE, { presentation: this.presentation, rate: this.rate, comment: this.comment })
      .then(() => this.close());
  }
